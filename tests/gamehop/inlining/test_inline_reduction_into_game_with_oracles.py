    ...
    def test_P2fromP1_into_G2(self):
        class G2_expected_result(Crypto.Game):
            ...
            def main(self) -> Crypto.Bit:
                ...
                b = random.choice([0, 1])
                msge = "hi!" if b == 0 else "bye"
                P2fromP1_ENCᴠ1ⴰct = P1.Encrypt(self.pk.pk, msge)
    ...
    def test_R_into_G1(self):
        ...
        class G2_expected_result(Crypto.Game):
            ...
            def main(self) -> Crypto.Bit:
                ...
                self_adversary_hi_or_byeᴠ1ⴰpkprime = P2fromP1.PK(self.pk)
                self_adversary_hi_or_byeᴠ1ⴰctprime = P2fromP1.CT(ct)
                self_adversary_hi_or_byeᴠ1ⴰg = self.adversary.hi_or_not(self_adversary_hi_or_byeᴠ1ⴰpkprime, self_adversary_hi_or_byeᴠ1ⴰctprime, self.o_encconcat)
